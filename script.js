    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בינגו איתור נזקי מים ופתרונות אל הרס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c7af1113-5e92-4677-9811-f168ce8991f9',
                    name: data.name || '',
                    email: data.email || '',
